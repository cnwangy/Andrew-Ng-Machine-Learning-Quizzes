...
rem
rem    $Revision: 1.1.6.10.2.1 $  $Date: 2012/07/12 13:53:45 $
...
set MATLAB=%MATLAB%
set VSINSTALLDIR=I:\Program Files\Microsoft Visual Studio 9.0
set VCINSTALLDIR=%VSINSTALLDIR%\VC
rem In this case, LINKERDIR is being used to specify the location of the SDK
set LINKERDIR=H:\Program Files\\Microsoft SDKs\Windows\v6.0A\
